...
def main():
    ...
    train_data.to_csv(os.path.join(OUTPUT_PATH, 'data', args.train_data_file), index=False)
    train_target.to_csv(os.path.join(OUTPUT_PATH, 'data', args.train_target_file), index=False)
    test_data.to_csv(os.path.join(OUTPUT_PATH, 'data', args.test_data_file), index=False)
    test_target.to_csv(os.path.join(OUTPUT_PATH, 'data', args.test_target_file), index=False)
    to_pkl(encoder, os.path.join(OUTPUT_PATH, 'data', args.encoder_file))
